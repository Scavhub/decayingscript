...
function Kavo.CreateLib(kavName, themeList)
    ...
    Main.BackgroundColor3 = Color3.fromRGB(36, 37, 43) -- Base color
    Main.BackgroundTransparency = 0.5 -- Semi-transparent for glass effect

    -- Add a UIGradient for the glass effect
    local uiGradient = Instance.new("UIGradient")
    uiGradient.Parent = Main
    uiGradient.Color = ColorSequence.new{
        ColorSequenceKeypoint.new(0, Color3.fromRGB(255, 255, 255)), -- Start color
        ColorSequenceKeypoint.new(1, Color3.fromRGB(0, 0, 0)) -- End color
    }
    uiGradient.Transparency = NumberSequence.new{
        NumberSequenceKeypoint.new(0, 0.5), -- Start transparency
        NumberSequenceKeypoint.new(1, 0.5) -- End transparency
    }
